...
const ResumeViewer = () => {
  ...
  <div className="p-3 mx-auto bg-white rounded-lg max-w-5xl w-full">
    ...
    {/* Upload Section */}
    {!pdfUrl && !loading && (
      <div className="sm:w-3/4 w-full flex flex-col p-6 border border-gray-300 rounded-lg bg-gray-50 text-center shadow-md mx-auto">
  ...
  >
    <div className="bg-white p-6 rounded-xl shadow-lg max-w-sm w-full text-center">
      <h3 className="text-xl font-semibold text-gray-800">Delete Resume?</h3>
